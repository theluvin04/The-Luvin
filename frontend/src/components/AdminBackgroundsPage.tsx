...
const AdminBackgroundsPage: React.FC<{
    ...
    const handleSave = async (backgroundToSave: BackgroundWithType) => {
        ...
        const url = isNew 
            ? `${API_BASE_URL}/api/backgrounds/${backgroundToSave.type}`
            : `${API_BASE_URL}/api/backgrounds/${backgroundToSave.type}/${backgroundToSave.id}`;
        ...
        try {
            const response = await fetch(url, {
                ...
                body: JSON.stringify(backgroundToSave),
            });
    ...
    const handleDelete = async (backgroundToDelete: BackgroundWithType) => {
        ...
        try {
             const response = await fetch(`${API_BASE_URL}/api/backgrounds/${backgroundToDelete.type}/${backgroundToDelete.id}`, {
                method: 'DELETE',
            });
