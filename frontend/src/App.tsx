...
import type { Page, FrameConfig, LegoPart, DraggableItem, TextConfig, LegoCharacterConfig, OutfitColor, OrderDetails, StoredOrder, OrderStatus, AllProducts, AllBackgrounds, FrameOption } from './types';
import { 
...
export const API_BASE_URL = ''; // No longer needed
  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
        ...
        (backgroundsData || []).forEach(b => {
            if (b.type === 'square') backgrounds.square.push(b);
            else if (b.type === 'rectangle') backgrounds.rectangle.push(b);
        });
