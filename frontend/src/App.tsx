...
import type { Page, FrameConfig, LegoPart, DraggableItem, TextConfig, LegoCharacterConfig, OutfitColor, OrderDetails, StoredOrder, OrderStatus, AllProducts } from './types';
import { 
    FRAME_OPTIONS, 
    LEGO_PARTS, 
