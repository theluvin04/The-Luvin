...
interface CollectionPageProps {
    ...
    onViewDetail: (template: CollectionTemplate) => void, 
...
export const CollectionPage: React.FC<CollectionPageProps> = ({ navigateTo, onViewDetail, templates, onZoomImage, allParts, frames }) => {
                  ...
                  {filteredTemplates.map((template, index) => {
                    ...
                    return ( 
                        <div 
                            ...
                            className="group bg-white rounded-xl p-4 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 flex flex-col h-full cursor-pointer"
                        ...
                        >
                            ...
                            <div className="relative aspect-square bg-[#f4eee8] rounded-lg overflow-hidden mb-4 group-hover:bg-[#efe5dc] transition-colors">
                                ...
                                <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 z-20">
